        ...
        <div class="swiper features-slider">
          <ul class="swiper-wrapper header-features">
            <li class="swiper-slide header-features-item">
              ...
              <p class="header-features-text">Непрерывная работа c&nbsp;2017</p>
            </li>
            <li class="swiper-slide header-features-item">
              <svg width="36" height="36">
        ...
        <div class="swiper steps-slider">
          <ol class="swiper-wrapper steps">
            ...
            <li class="swiper-slide steps-item">
              ...
              <p class="steps-text">
                В&nbsp;частности, экономическая повестка сегодняшнего дня
        ...
        <div class="trademark-cards">
          <div class="trademark-card">
            <svg class="trademark-card-logo">
              <use href="img/sprite.svg#logo-AG"></use>
            </svg>
          ...
          <div class="trademark-card">
            <svg class="trademark-card-logo">
              <use href="img/sprite.svg#logo-AP"></use>
            </svg>
        ...
        <div class="founder-content-wrapper">
          <div class="founder-content">
            ...
            <p class="founder-text">
              ...
              А&nbsp;ещё действия представителей оппозиции, превозмогая
              сложившуюся непростую экономическую ситуацию, в&nbsp;равной
              степени предоставлены сами себе. Не&nbsp;следует, однако,
              забывать, что выбранный нами инновационный путь
              в&nbsp;значительной степени обусловливает важность дальнейших
      ...
      <div class="container">
        ...
        <div class="swiper blog-slider">
          ...
          <div class="blog-slider-footer">
            <a href="#" class="button-link blog-link">Весь блок</a>
